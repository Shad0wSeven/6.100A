...
def put_in_functions_a():
    try:
        ...
        FUNCTION_HEADER = 'def %s(annual_salary, percent_saved, total_cost_of_home):' % (FUNCTION_NAME)
        ...
        new_lines = []
        lines = [line.rstrip('\n') for line in open(STUDENT_FILE_NAME)]
...
def put_in_functions_b():
    try:
        ...
        FUNCTION_HEADER = 'def %s(annual_salary, percent_saved, total_cost_of_home, semi_annual_raise):' % (FUNCTION_NAME)
